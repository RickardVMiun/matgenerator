const weekfood = [
{
    ...
    "ingredienter": "https://www.mathem.se/recept/korv-och-makaroner"
},
{
...
console.log(weekendarr);
    ...
    document.querySelector('#mondayingredient').href = weekfood[weekarr[0]].ingredienter;
    ...
    document.querySelector('#tuesdayingredient').href = weekfood[weekarr[1]].ingredienter;
    ...
    document.querySelector('#wednesdayingredient').href = weekfood[weekarr[2]].ingredienter;
    ...
    document.querySelector('#thursdayingredient').href = weekfood[weekarr[3]].ingredienter;
    ...
    document.querySelector('#fridayingredient').href = weekfood[weekarr[4]].ingredienter;
    ...
    document.querySelector('#saturdayingredient').href = weekendfood[weekendarr[0]].ingredienter;
    ...
    document.querySelector('#sundayingredient').href = weekendfood[weekendarr[1]].ingredienter;
  }
